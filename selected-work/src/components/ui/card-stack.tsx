            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 overflow-hidden rounded-2xl border-4 border-black/10 shadow-xl",
                  ...
                  onClick={() => {
                    if (isActive) onActiveClick?.(item);
                    else setActive(i);
                  }}
                  {...dragProps}
                >
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "bg-slate-900" : "bg-slate-900/30 hover:bg-slate-900/50",
                  )}
